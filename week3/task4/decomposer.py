...
if __name__ == "__main__":
    ...
    candidates = [
        script_dir / "sql_questions_only.csv",
        script_dir.parent / "task2" / "sql_questions_only.csv",
        script_dir.parent / "sql_questions_only.csv",
        Path.cwd() / "sql_questions_only.csv",
    ]
    csv_path = next((p for p in candidates if p.exists()), None)
    if csv_path is None:
        raise FileNotFoundError(
            "Could not find sql_questions_only.csv. Tried: "
